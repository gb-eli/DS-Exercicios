# DS Exercícios v14.10.8.36 — Bugfix cumulativo
...
### Lobby / Campus DS
- uma única release executável: `14.10.8.36`;
...
- assets do Portal usam o mesmo cache-buster da v14.10.8.36;
...
Não há migration nova específica da v14.10.8.36.

import { CAMPUS_ZONE_LAYOUT } from './campus-manifest.js?v=14.10.8.60';
import { CAMPUS_EXPERIENCES, PARKOUR_PLATFORMS, CAMPUS_RIDES, CAMPUS_TRAIN_STATIONS, CAMPUS_TRAIN_ROUTE, CAMPUS_VERTICAL_SURFACES } from './campus-experiences.js?v=14.10.8.60';
...
function createExperienceZone({THREE,quality,experience,spriteLabel}){
  ...
  if(experience.type==='vale-portal'){
    // v14.10.8.60: estação/portal monumental do Vale, visível de longe no Campus 3D.

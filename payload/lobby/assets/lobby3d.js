import { WORLD_X, WORLD_Z, CAMPUS_ZONE_LAYOUT, EXTERIOR_BUILDING_COLLIDERS, presenceToWorld, worldToPresence, areaAtWorld } from './world/campus-manifest.js?v=14.10.8.56';
import { createCampusEnvironment, createCampusLighting } from './world/campus-environment.js?v=14.10.8.56';
import { createCameraController } from './render/camera-controller.js?v=14.10.8.56';
import { createAvatarSystem } from './characters/avatar-system.js?v=14.10.8.56';
import { createPortalSystem } from './game/portal-manager.js?v=14.10.8.56';
import { detectPerformanceProfile, chooseInitialQuality, createResizeController, createAdaptiveQualityController } from './render/performance-manager.js?v=14.10.8.56';
import { CAMPUS_EXPERIENCES, CAMPUS_TRAIN_STATIONS, LITE_PARKOUR_CHECKPOINTS, PARKOUR_START, parkourPlatformAt, campusSurfaceAt } from './world/campus-experiences.js?v=14.10.8.56';
...
import { resolveWorldTime } from './world/dynamic-world.js?v=14.10.8.56';

const THREE_URL='../vendor/three/three.module.min.js?v=14.10.8.56';

import { WORLD_X, WORLD_Z, CAMPUS_ZONE_LAYOUT, EXTERIOR_BUILDING_COLLIDERS, presenceToWorld, worldToPresence, areaAtWorld } from './world/campus-manifest.js?v=14.10.8.55';
import { createCampusEnvironment, createCampusLighting } from './world/campus-environment.js?v=14.10.8.55';
...
import { createPortalSystem } from './game/portal-manager.js?v=14.10.8.55';
import { detectPerformanceProfile, chooseInitialQuality, createResizeController, createAdaptiveQualityController } from './render/performance-manager.js?v=14.10.8.55';
import { CAMPUS_EXPERIENCES, LITE_PARKOUR_CHECKPOINTS, PARKOUR_START, parkourPlatformAt } from './world/campus-experiences.js?v=14.10.8.55';

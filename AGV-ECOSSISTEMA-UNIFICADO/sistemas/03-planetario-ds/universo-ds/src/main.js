...
import { WebGLCosmosRenderer } from './rendering/WebGLCosmosRenderer.js';
...
const renderer = new WebGLCosmosRenderer(document.querySelector('#cosmos-canvas'), settingsStore, bus);
...
app.init().then(() => renderer.start()).catch(error => {
  console.error(error);

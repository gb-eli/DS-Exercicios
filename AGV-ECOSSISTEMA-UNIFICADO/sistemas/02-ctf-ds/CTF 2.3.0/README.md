# CTF DS — Cyber Security Lab v2.3.0
...
## Proteção Anti-Leak v2.3

- respostas determinísticas verificadas por comprovantes AES-GCM selados;
- validadores estruturais para desafios de código com múltiplas soluções;
- comprovante de captura vinculado ao perfil;
- nenhum catálogo público `fase → resposta`;
- detecção local de conclusão anormalmente rápida, sem banimento automático;
- carteira e inventário continuam derivados de extrato reconciliado.

Consulte `ANTI_LEAK_SECURITY.md` para arquitetura e limitações.

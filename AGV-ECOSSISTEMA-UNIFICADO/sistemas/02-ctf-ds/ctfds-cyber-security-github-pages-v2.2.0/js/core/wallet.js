...
const createWallet = (profile) => ({
  ...
  migration: { fromLegacyFields: true, at: new Date().toISOString(), appVersion: '2.2.0' },
});
...
const rawAppend = (profile, input) => {
  ...
  const tx = {
    ...
    appVersion: '2.2.0', toolVersion: input.toolVersion || '', deviceSessionId: input.deviceSessionId || '',

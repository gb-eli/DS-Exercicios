# Exercícios Práticos DS v0.14.1 — P3

Hotfix cumulativo sobre v0.14.0: herança turma→aluno dos recursos de apoio e starter seguro HTML/CSS/JS quando liberado pelo professor. Arquivos já existentes nunca são sobrescritos.

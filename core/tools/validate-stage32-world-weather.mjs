...
check('cache da fase 32 ou posterior protege runtimes e weather-system',/runtime-\$\{VERSION\}-stage(?:3[2-9]|[4-9]\d|\d{3,})/.test(sw)&&/vendor-loader\.js\?v=14\.10\.8\.65-stage(?:3[2-9]|[4-9]\d|\d{3,})/.test(html)&&/lobby3d\.js\?v=14\.10\.8\.65-stage(?:3[2-9]|[4-9]\d|\d{3,})/.test(app)&&/weather-system\.js\?v=14\.10\.8\.65-stage(?:3[2-9]|[4-9]\d|\d{3,})/.test(sw));

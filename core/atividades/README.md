# Exercícios Práticos DS v0.14.3 — P4.3 Security Hardening

Versão P4.1 integrada ao Lobby Geral. Liberação continua server-side; importação legada não contorna bloqueios, equipe usa credencial temporária individual e a orientação do workspace evita interpolação de conteúdo do banco em innerHTML.

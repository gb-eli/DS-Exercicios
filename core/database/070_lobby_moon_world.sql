-- F75 / v14.10.8.77 — Lua AGV
-- Amplia lobby_presence.area para a superfície lunar carregada sob demanda.
...
alter table public.lobby_presence
  ...
  check (area in ('central','1ds','2ds','3ds','sub','vale-silicio','rural-agv','military-agv','space-agv','moon-agv'));

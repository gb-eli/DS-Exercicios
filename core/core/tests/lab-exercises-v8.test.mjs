...
const expected={ds1:8,ds2:28,subfe:7,submob:4};
...
const ds3Redirect=read('sistemas/10-lab-exercicios-ds3/modo-aluno/index.html');assert.match(ds3Redirect,/atividades\//,'DS3 legado redireciona para plataforma integrada');

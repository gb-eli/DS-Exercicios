...
assert.ok(cfg.includes("LOBBY_VERSION='0.8.0'")||cfg.includes("LOBBY_VERSION='0.9.0'")||cfg.includes("LOBBY_VERSION='1.0.1'"),'Lobby dinâmico deve permanecer compatível');

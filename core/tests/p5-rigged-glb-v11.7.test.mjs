...
assert.ok(/import\('\.\.\/rigged-avatar\.js\?v=14\.10\.8\.65(?:-stage\d+)?'\)/.test(avatar)&&avatar.includes("rigAsset?'rigged-glb-v2':'procedural-v2'")&&avatar.includes('proceduralBody'),'fallback GLB/procedural ausente');assert.ok(lobby.includes('getAvatarMode:()=>avatarSystem.getMode()'),'renderer deve consultar o Avatar System');

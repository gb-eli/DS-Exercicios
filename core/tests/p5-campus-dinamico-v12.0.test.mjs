...
const currentRelease=JSON.parse(fs.readFileSync(new URL('../../release-current.json',import.meta.url),'utf8'));
assert.ok(cfg.includes(`LOBBY_VERSION='${currentRelease.version}'`),'Lobby deve declarar a release corrente');

(function(global){
  ...
  function create(config={}){
    ...
    read();
    return {storageKey,read,save,clear,valid,getSession,requireSession,refresh,getUser,signIn,signUpStudent,signOut,request:authorizedFetch,rawRequest:request,onStorage,destroy,get session(){return session;}};
  }

> Atualização mais recente: **v12.2 / P5.8 — Laboratórios Interativos** (15/08/2026).
...
## Atualização v8 — LABs DS + Professor

DS1, DS2, DS3 e Sub agora possuem Auth/progresso central no AGV Education Core. Os bundles aluno foram auditados para retirar gabaritos/soluções completas embutidas. O Modo Professor ganhou revisão e importação privada de referências. Consulte `docs/P1-LABS-DS-CORE-v8.md`.

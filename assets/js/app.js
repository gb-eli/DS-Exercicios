import { openStaffPanel, isStaff } from './admin.js?v=14.10.8.36';
import { mountWorkspace, unmountWorkspace } from './workspace.js?v=14.10.8.36.1';
import { callActivityProgress } from './supervision.js?v=14.10.8.36';
import { requestPortalFullscreen, setPortalFullscreenRequired } from './fullscreen.js?v=14.10.8.36';
import { supabase, SUPABASE_SDK_AVAILABLE, SUPABASE_SDK_ERROR } from './supabase.js?v=14.10.8.36';
import { SCHOOL_EMAIL_DOMAIN } from './config.js?v=14.10.8.36';
...
$('lobby-btn')?.addEventListener('click', () => { window.location.href = '../lobby/?v=14.10.8.36'; });

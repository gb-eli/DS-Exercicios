import { CAMPUS_ZONE_LAYOUT } from './campus-manifest.js?v=14.10.8.46';
...
export function createCampusEnvironment({THREE,scene,zones,quality,spriteLabel}){
  ...
  const cameraCollisionRoots=[],buildingRoots=[];
  let variant=0;
  ...
  return {floor,centralFountain,beacon:centralFountain,canopy,cameraCollisionRoots,buildingRoots};
}

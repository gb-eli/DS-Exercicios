...
export const CAMPUS_DRIVABLE_VEHICLES=Object.freeze([
  Object.freeze({id:'drive-west-car',name:'AGV E-Car',garageId:'garage-west',x:-41.2,z:-9.5,kind:'car',accent:'#55d9ff',routeId:'west-loop',startT:.38,durationMs:20000}),
  Object.freeze({id:'drive-west-bike',name:'AGV E-Bike',garageId:'garage-west',x:-37.0,z:-9.5,kind:'bike',accent:'#ff7fd5',routeId:'west-loop',startT:.38,durationMs:15500}),
  Object.freeze({id:'drive-east-van',name:'Maker Van',garageId:'garage-east',x:37.0,z:9.5,kind:'van',accent:'#61e7a6',routeId:'east-loop',startT:.38,durationMs:21000}),
  Object.freeze({id:'drive-south-shuttle',name:'Shuttle Acadêmico',garageId:'garage-south',x:28.7,z:-30,kind:'bus',accent:'#ffae63',routeId:'mobility-south',startT:.47,durationMs:23000})
]);

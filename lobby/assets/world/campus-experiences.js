...
export const CAMPUS_RIDES=Object.freeze({
  ...
  coaster:Object.freeze({id:'coaster',duration:18.5,camera:'campus',loop:false,nodes:freezeNodes([
    [34,.7,-6],[30,.7,-7],[23,.7,-12.5],[12,.7,-11],[0,.7,-25.5],[-12,.7,-11],[-23,.7,-12.5],[-30,.7,-7],
    [-30,.7,7],[-23,.7,12.5],[-14,.7,11.5],[0,.7,15.5],[14,.7,11.5],[23,.7,12.5],[30,.7,7],[34,.7,-6]
  ])}),

...
const createCampus3DLazy=async context=>(await import('../lobby3d.js?v=14.10.8.92-f90-graphics')).createLobby3D(context);
...
const createVale3DLazy=async context=>(await import('../vale3d.js?v=14.10.8.92-f90-graphics')).createVale3D(context);
...
const createRural3DLazy=async context=>(await import('../rural3d.js?v=14.10.8.92-f90-graphics')).createRural3D(context);
...
const createMilitary3DLazy=async context=>(await import('../military3d.js?v=14.10.8.92-f90-graphics')).createMilitary3D(context);
...
const createSpace3DLazy=async context=>(await import('../space3d.js?v=14.10.8.92-f90-graphics')).createSpace3D(context);
...
const createMoon3DLazy=async context=>(await import('../moon3d.js?v=14.10.8.92-f90-graphics')).createMoon3D(context);
...
const createMars3DLazy=async context=>(await import('../mars3d.js?v=14.10.8.92-f90-graphics')).createMars3D(context);
...
const createParque3DLazy=async context=>(await import('../parque-diversoes-agv3d.js?v=14.10.8.92-f90-graphics')).createParqueDiversoes3D(context);
...
const createColegioLiteLazy=async context=>(await import('../colegio-agv-host.js?v=14.10.8.92-f90-graphics')).createColegioAgvHostedLite(context);
const createColegio3DLazy=async context=>(await import('../colegio-agv-host.js?v=14.10.8.92-f90-graphics')).createColegioAgvHosted3D(context);
...
const createLabirintoLiteLazy=async context=>(await import('../labirinto-armadilhas-host.js?v=14.10.8.92-f90-graphics')).createLabirintoArmadilhasHostedLite(context);
const createLabirinto3DLazy=async context=>(await import('../labirinto-armadilhas-host.js?v=14.10.8.92-f90-graphics')).createLabirintoArmadilhasHosted3D(context);
...
const createMuseu3DLazy=async context=>(await import('../museu-hardware3d.js?v=0.8.0-f90-graphics')).createMuseuHardware3D(context);
...
const createAirdropTransit3DLazy=async context=>(await import('../airdrop-transit3d.js?v=14.10.8.92-f90-graphics')).createAirdropTransit3D(context);

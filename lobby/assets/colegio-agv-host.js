...
import { createColegioAgv3D } from './colegio-agv3d.js?v=14.10.8.95-f93-special-graphics';
import { MAP_ID, MAP_LABEL, MAP_BOUNDS, MAP_SPAWN, MAP_RETURN_PORTAL } from './world/colegio-agv-shared.js?v=1.6.0-f7';
import { createPluginWorldLiteHost, createPluginWorld3DHost, mapWorldToPresence, mapPresenceToWorld } from './plugin-world-host.js?v=14.10.8.96-f94-auto-calibration';

...
async function start(){
  ...
  for(const asset of ['lobby.js','supabase.js','config.js','lobby3d.js','lobby-lite.js','world/campus-manifest.js','world/campus-environment.js','render/camera-controller.js','characters/avatar-system.js','game/portal-manager.js'])await probeAsset(asset);

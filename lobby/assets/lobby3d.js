...
import { createCampusEnvironment, createCampusLighting } from './world/campus-environment.js?v=14.10.8.65-stage29';
import { createCameraController } from './render/camera-controller.js?v=14.10.8.65';
import { createAvatarSystem } from './characters/avatar-system.js?v=14.10.8.65-stage34';
...
import { CAMPUS_EXPERIENCES, CAMPUS_TRAIN_STATIONS, LITE_PARKOUR_CHECKPOINTS, PARKOUR_START, parkourPlatformAt, campusSurfaceAt } from './world/campus-experiences.js?v=14.10.8.65-stage28';
...
import { CAMPUS_TRAFFIC_FLEET, CAMPUS_DRIVABLE_VEHICLES, CAMPUS_NPC_PATROLS, CAMPUS_DYNAMIC_SIGNS, CAMPUS_INTERIOR_SIGNATURES, CAMPUS_ELEVATOR_SYSTEM, resolveCampusCityEvent, resolveDynamicSign, sampleCampusRoute } from './world/campus-mobility-systems.js?v=14.10.8.65-stage28';
import { CAMPUS_INTERIOR_PROFILES, CAMPUS_INTERIOR_MAP, CAMPUS_INTERIOR_INTERACTIONS, CAMPUS_CLASSROOM_INTERIOR_THEMES, interiorRoomStyle, contextualInteriorAnchor } from './world/campus-interiors.js?v=14.10.8.65-stage34';
...
import { CAMPUS_AMBIENT, ambientBudget } from './world/ambient-landscape.js?v=14.10.8.65-stage30';
...
function toolInterior(profile){
  ...
  const floors=new Map(),doors=new Map(),elevatorPanels=new Map(),ambientNodes=[];
  ...
  root.userData={kind:'tool-interior',interiorId:profile.id,styleFamily:style.family||profile.template};setShadow(root,true);return{group:root,floors,doors,elevatorPanels,elevatorCabin,elevatorMotion:null,refs,profile,ambientNodes,elevatorAnimUntil:0,receptionistAvatar:null};
}

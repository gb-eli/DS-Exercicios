import { WORLD_X, WORLD_Z, CAMPUS_ZONE_LAYOUT, EXTERIOR_BUILDING_COLLIDERS, presenceToWorld, worldToPresence, areaAtWorld } from './world/campus-manifest.js?v=14.10.8.52';
import { createCampusEnvironment, createCampusLighting } from './world/campus-environment.js?v=14.10.8.52';
import { createCameraController } from './render/camera-controller.js?v=14.10.8.52';
import { createAvatarSystem } from './characters/avatar-system.js?v=14.10.8.52';
import { createPortalSystem } from './game/portal-manager.js?v=14.10.8.52';
import { detectPerformanceProfile, chooseInitialQuality, createResizeController, createAdaptiveQualityController } from './render/performance-manager.js?v=14.10.8.52';
import { CAMPUS_EXPERIENCES, LITE_PARKOUR_CHECKPOINTS, PARKOUR_START, parkourPlatformAt } from './world/campus-experiences.js?v=14.10.8.52';
...
const THREE_URL='../vendor/three/three.module.min.js?v=14.10.8.52';

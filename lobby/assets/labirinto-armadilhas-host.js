...
import { createLabirintoArmadilhas3D } from './labirinto-armadilhas3d.js?v=14.10.8.95-f93-special-graphics';
...
import { createPluginWorldLiteHost, createPluginWorld3DHost, mapWorldToPresence, mapPresenceToWorld, nearestPortal } from './plugin-world-host.js?v=14.10.8.96-f94-auto-calibration';

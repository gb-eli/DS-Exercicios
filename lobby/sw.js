...
const CACHE_NAME=`agv-lobby-runtime-${VERSION}-stage77-f9414-network-manager`; 
...
const CRITICAL_SHELL=[
  './',
  './index.html',
  './assets/diagnostics.js?v=14.10.8.96-f9414-network-manager',
  './assets/sw-register.js?v=14.10.8.96-stage77-f9414-network-manager',
  './assets/vendor-loader.js?v=14.10.8.96-stage77-f9414-network-manager',
  './assets/boot.js?v=14.10.8.96-stage77-f9414-network-manager',
  './assets/supabase.js?v=14.10.8.66',
  './assets/lobby.js?v=14.10.8.96-stage77-f9414-network-manager',
  './assets/config.js?v=14.10.8.96',
  './assets/core/lobby-state.js?v=14.10.8.96-f9414-network-manager',
  './assets/core/world-manager.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/core/runtime-v2/world-runtime-contract.js?v=14.10.8.96-f9412-vehicle-core',
  ...
  './assets/core/vehicle-v2/vehicle-contract.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/core/vehicle-v2/vehicle-physics-adapter.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/core/vehicle-v2/vehicle-controller.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/core/vehicle-v2/vehicle-registry.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/core/vehicle-v2/vehicle-network-protocol.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/core/world-adapter.js?v=14.10.8.96-f9412-vehicle-core',
  ...
  './assets/lobby-lite.js?v=14.10.8.96-f9412-vehicle-core',
  ...
  './assets/social/realtime-avatar-sync.js?v=14.10.8.96-f9414-network-manager',
  ...
  './assets/lobby.css?v=14.10.8.96-stage77-f9414-network-manager',
  './vendor/supabase/supabase.js'
];
const OPTIONAL_SHELL=[
  './assets/core/network-v2/network-stack.js?v=14.10.8.96-f9414-network-manager',
  './assets/core/network-v2/network-manager.js?v=14.10.8.96-f9414-network-manager',
  './assets/core/network-v2/network-protocol.js?v=14.10.8.96-f9414-network-manager',
  './assets/core/network-v2/transport-contract.js?v=14.10.8.96-f9414-network-manager',
  './assets/core/network-v2/colyseus-transport.js?v=14.10.8.96-f9414-network-manager',
  './assets/core/network-v2/supabase-transport.js?v=14.10.8.96-f9414-network-manager',
  './assets/core/network-v2/solo-transport.js?v=14.10.8.96-f9414-network-manager',
  ...
  './assets/core/physics-v2/physics-module-loader.js?v=14.10.8.96-f9413-rapier-bvh-pilot',
  './assets/core/physics-v2/mesh-bvh-collider.js?v=14.10.8.96-f9413-rapier-bvh-pilot',
  './assets/core/physics-v2/rapier-vehicle-world.js?v=14.10.8.96-f9413-rapier-bvh-pilot',
  './assets/core/physics-v2/campus-physics-pilot.js?v=14.10.8.96-f9413-rapier-bvh-pilot',
  ...
  './assets/lobby3d.js?v=14.10.8.96-f9413-rapier-bvh-pilot',
  './assets/moon-lite.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/moon3d.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/mars-lite.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/mars3d.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/world/world-runtime-prefetch.js?v=14.10.8.96-f9412-vehicle-core',
  './assets/airdrop-transit3d.js?v=14.10.8.96-f9412-vehicle-core',

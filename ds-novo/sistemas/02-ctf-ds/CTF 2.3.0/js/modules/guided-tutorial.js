...
const TOOL_DEMOS = {
  ...
  logs: {
    title: 'Analisador de Logs', input: '2026-07-29T08:00:00Z auth FAIL user=admin ip=192.0.2.44\n2026-07-29T08:00:03Z auth OK user=aluno ip=192.0.2.18\n2026-07-29T08:00:05Z auth FAIL user=admin ip=192.0.2.44', fields: {},
    concept: 'Logs permitem reconstruir eventos, localizar padrões e priorizar alertas sem tocar no sistema original.',
    outcome: 'O relatório destaca 192.0.2.44 como origem mais frequente.',
  },
  headers: {

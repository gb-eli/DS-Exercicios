# Matriz de testes dos jogos — Fliperama DS v0.36.0

Gerada em: 2026-08-07T23:12:38.394Z

- Jogos analisados: **18**
- Aprovados nesta camada: **18**
- Com verificações pendentes de playtest: **0**
- Com falha automatizada: **0**
- Verificações aprovadas: **116**
- Alertas: **0**
- Falhas: **0**
...
- **APROVADO — Inicialização da simulação:** Construtor, início, um ciclo de atualização e restauração executaram sem exceção.
- **APROVADO — Objetivos e transições:** 30 entidades e saídas acessíveis, incluindo o Console do Núcleo.

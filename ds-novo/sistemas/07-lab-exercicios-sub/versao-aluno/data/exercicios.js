window.EXERCICIOS_FRONTEND = [
  ...
  },
  {
    ...
    "arquivos": {
      "html": "<!DOCTYPE html>\n<html lang=\"pt-BR\">\n<head>\n    <meta charset=\"UTF-8\">\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    <title>Dashboard operacional responsivo</title>\n    <link rel=\"stylesheet\" href=\"estilo.css\">\n    <script src=\"script.js\" defer></script>\n</head>\n<body>\n    <a class=\"pular-conteudo\" href=\"#dashboard\">Pular para o dashboard</a>\n\n    <header class=\"topo\">\n        <div>\n            <p class=\"etiqueta\">FE06 - CSS Grid e responsividade</p>\n            <h1>Dashboard operacional</h1>\n            <p class=\"introducao\">Indicadores e áreas de trabalho que reorganizam colunas e regiões conforme a largura da tela.</p>\n        </div>\n        <button id=\"alternarDensidade\" type=\"button\" aria-pressed=\"false\" aria-controls=\"dashboard\">\n            Ativar modo compacto\n        </button>\n    </header>\n\n    <main id=\"dashboard\" class=\"dashboard\">\n        <section id=\"resumo\" class=\"resumo\" aria-labelledby=\"titulo-resumo\">\n            <div class=\"secao-cabecalho\">\n                <div>\n                    <p class=\"sobrelinha\">Visão geral</p>\n                    <h2 id=\"titulo-resumo\">Indicadores de hoje</h2>\n                </div>\n                <p id=\"statusLayout\" role=\"status\" aria-live=\"polite\">Layout confortável ativo.</p>\n            </div>\n\n            <div class=\"grade-indicadores\">\n                <article class=\"indicador\">\n                    <span>Chamados abertos</span>\n                    <strong>18</strong>\n                    <small>3 com prioridade alta</small>\n                </article>\n                <article class=\"indicador\">\n                    <span>Concluídos</span>\n                    <strong>27</strong>\n                    <small>60% da meta diária</small>\n                </article>\n                <article class=\"indicador\">\n                    <span>Tempo médio</span>\n                    <strong>42 min</strong>\n                    <small>8 min abaixo de ontem</small>\n                </article>\n                <article class=\"indicador\">\n                    <span>Satisfação</span>\n                    <strong>94%</strong>\n                    <small>32 avaliações recebidas</small>\n                </article>\n            </div>\n        </section>\n\n        <section id=\"tarefas\" class=\"painel painel-tarefas\" aria-labelledby=\"titulo-tarefas\">\n            <div class=\"painel-cabecalho\">\n                <h2 id=\"titulo-tarefas\">Tarefas prioritárias</h2>\n                <span class=\"selo\">4 itens</span>\n            </div>\n            <ul class=\"lista-tarefas\">\n                <li><span>Revisar formulário de orçamento</span><strong>09:30</strong></li>\n                <li><span>Atualizar catálogo de serviços</span><strong>11:00</strong></li>\n                <li><span>Validar página institucional</span><strong>14:00</strong></li>\n                <li><span>Publicar relatório semanal</span><strong>16:30</strong></li>\n            </ul>\n        </section>\n\n        <section id=\"agenda\" class=\"painel painel-agenda\" aria-labelledby=\"titulo-agenda\">\n            <h2 id=\"titulo-agenda\">Agenda da equipe</h2>\n            <article class=\"evento\">\n                <time datetime=\"2026-08-05T19:10\">19:10</time>\n                <div><strong>Reunião rápida</strong><p>Distribuição das demandas da noite.</p></div>\n            </article>\n            <article class=\"evento\">\n                <time datetime=\"2026-08-05T20:30\">20:30</time>\n                <div><strong>Revisão técnica</strong><p>Teste dos projetos em diferentes telas.</p></div>\n            </article>\n        </section>\n\n        <section id=\"equipe\" class=\"painel painel-equipe\" aria-labelledby=\"titulo-equipe\">\n            <h2 id=\"titulo-equipe\">Equipe disponível</h2>\n            <div class=\"grade-equipe\">\n                <span>Ana - Front-End</span>\n                <span>Bruno - Suporte</span>\n                <span>Carla - Conteúdo</span>\n                <span>Diego - Testes</span>\n            </div>\n        </section>\n\n        <aside id=\"alertas\" class=\"painel painel-alertas\" aria-labelledby=\"titulo-alertas\">\n            <h2 id=\"titulo-alertas\">Alertas</h2>\n            <article class=\"alerta urgente\">\n                <strong>Prazo próximo</strong>\n                <p>O formulário de orçamento deve ser revisado antes das 20h.</p>\n            </article>\n            <article class=\"alerta informativo\">\n                <strong>Teste responsivo</strong>\n                <p>Confirme o dashboard em computador, tablet e celular.</p>\n            </article>\n        </aside>\n    </main>\n\n    <footer class=\"rodape-pagina\">\n        <p>Exercício FE06 - Programação Front-End - 2 DS Subsequente</p>\n    </footer>\n</body>\n</html>\n",
      "css": ":root {\n    --fundo: #07101d;\n    --superficie: #10243a;\n    --superficie-clara: #173550;\n    --texto: #f5f8ff;\n    --texto-suave: #b8c8dc;\n    --destaque: #38bdf8;\n    --sucesso: #4ade80;\n    --alerta: #fbbf24;\n    --perigo: #fb7185;\n    --borda: #2d4a66;\n    --espaco: 20px;\n    --raio: 18px;\n}\n\n* {\n    box-sizing: border-box;\n}\n\nhtml {\n    scroll-behavior: smooth;\n}\n\nbody {\n    margin: 0;\n    min-height: 100vh;\n    font-family: Arial, Helvetica, sans-serif;\n    background: var(--fundo);\n    color: var(--texto);\n}\n\n.pular-conteudo {\n    position: absolute;\n    top: -70px;\n    left: 16px;\n    z-index: 10;\n    padding: 12px 16px;\n    border-radius: 10px;\n    background: var(--destaque);\n    color: #04131f;\n    font-weight: 800;\n}\n\n.pular-conteudo:focus {\n    top: 16px;\n}\n\n.topo,\n.dashboard,\n.rodape-pagina {\n    width: min(1180px, 92%);\n    margin-inline: auto;\n}\n\n.topo {\n    display: grid;\n    grid-template-columns: minmax(0, 1fr) auto;\n    align-items: end;\n    gap: var(--espaco);\n    padding: 42px 0 24px;\n}\n\n.etiqueta,\n.sobrelinha {\n    margin: 0 0 8px;\n    color: var(--destaque);\n    font-weight: 800;\n    letter-spacing: 0.06em;\n    text-transform: uppercase;\n}\n\nh1,\nh2,\np {\n    margin-top: 0;\n}\n\nh1 {\n    margin-bottom: 12px;\n    font-size: clamp(2.3rem, 6vw, 4.8rem);\n    line-height: 1.02;\n}\n\np,\nli,\nspan,\nsmall {\n    color: var(--texto-suave);\n    line-height: 1.55;\n}\n\nbutton {\n    min-height: 48px;\n    padding: 12px 18px;\n    border: 0;\n    border-radius: 12px;\n    background: var(--destaque);\n    color: #04131f;\n    font: inherit;\n    font-weight: 800;\n    cursor: pointer;\n}\n\nbutton:hover {\n    filter: brightness(1.1);\n}\n\nbutton:focus-visible,\na:focus-visible {\n    outline: 3px solid var(--texto);\n    outline-offset: 4px;\n}\n\n.dashboard {\n    display: grid;\n    grid-template-columns: minmax(0, 1.7fr) minmax(250px, 1fr) minmax(220px, 0.8fr);\n    grid-template-areas:\n        \"resumo resumo resumo\"\n        \"tarefas agenda alertas\"\n        \"tarefas equipe alertas\";\n    gap: var(--espaco);\n    align-items: stretch;\n}\n\n.resumo {\n    grid-area: resumo;\n}\n\n.painel-tarefas {\n    grid-area: tarefas;\n}\n\n.painel-agenda {\n    grid-area: agenda;\n}\n\n.painel-equipe {\n    grid-area: equipe;\n}\n\n.painel-alertas {\n    grid-area: alertas;\n}\n\n.secao-cabecalho {\n    display: grid;\n    grid-template-columns: minmax(0, 1fr) minmax(220px, 320px);\n    align-items: end;\n    gap: 16px;\n    margin-bottom: 16px;\n}\n\n#statusLayout {\n    margin: 0;\n    padding-left: 12px;\n    border-left: 4px solid var(--destaque);\n}\n\n.grade-indicadores {\n    display: grid;\n    grid-template-columns: repeat(auto-fit, minmax(180px, 1fr));\n    gap: var(--espaco);\n}\n\n.indicador,\n.painel {\n    border: 1px solid var(--borda);\n    border-radius: var(--raio);\n    background: var(--superficie);\n}\n\n.indicador {\n    min-width: 0;\n    padding: 20px;\n}\n\n.indicador span,\n.indicador strong,\n.indicador small {\n    display: block;\n}\n\n.indicador strong {\n    margin: 8px 0;\n    color: var(--texto);\n    font-size: 2rem;\n}\n\n.painel {\n    min-width: 0;\n    padding: 22px;\n}\n\n.painel-cabecalho {\n    display: grid;\n    grid-template-columns: minmax(0, 1fr) auto;\n    align-items: center;\n    gap: 12px;\n}\n\n.selo {\n    padding: 4px 9px;\n    border-radius: 999px;\n    background: var(--destaque);\n    color: #04131f;\n    font-size: 0.8rem;\n    font-weight: 900;\n}\n\n.lista-tarefas {\n    display: grid;\n    gap: 12px;\n    margin: 18px 0 0;\n    padding: 0;\n    list-style: none;\n}\n\n.lista-tarefas li {\n    display: grid;\n    grid-template-columns: minmax(0, 1fr) auto;\n    gap: 12px;\n    padding: 14px;\n    border-radius: 12px;\n    background: var(--superficie-clara);\n}\n\n.lista-tarefas strong,\n.evento strong,\n.alerta strong {\n    color: var(--texto);\n}\n\n.evento {\n    display: grid;\n    grid-template-columns: auto minmax(0, 1fr);\n    gap: 14px;\n    padding: 14px 0;\n    border-bottom: 1px solid var(--borda);\n}\n\n.evento:last-child {\n    border-bottom: 0;\n}\n\n.evento time {\n    color: var(--destaque);\n    font-weight: 900;\n}\n\n.evento p,\n.alerta p {\n    margin-bottom: 0;\n}\n\n.grade-equipe {\n    display: grid;\n    grid-template-columns: repeat(2, minmax(0, 1fr));\n    gap: 10px;\n}\n\n.grade-equipe span,\n.alerta {\n    padding: 12px;\n    border-radius: 12px;\n    background: var(--superficie-clara);\n}\n\n.painel-alertas {\n    display: grid;\n    align-content: start;\n    gap: 12px;\n}\n\n.alerta {\n    border-left: 4px solid var(--alerta);\n}\n\n.alerta.urgente {\n    border-left-color: var(--perigo);\n}\n\n.dashboard.modo-compacto {\n    --espaco: 12px;\n}\n\n.dashboard.modo-compacto .painel,\n.dashboard.modo-compacto .indicador {\n    padding: 14px;\n}\n\n.rodape-pagina {\n    padding: 24px 0 36px;\n}\n\n@media (max-width: 900px) {\n    .dashboard {\n        grid-template-columns: repeat(2, minmax(0, 1fr));\n        grid-template-areas:\n            \"resumo resumo\"\n            \"tarefas agenda\"\n            \"equipe alertas\";\n    }\n\n    .painel-tarefas {\n        min-height: auto;\n    }\n}\n\n@media (max-width: 620px) {\n    .topo,\n    .secao-cabecalho,\n    .dashboard {\n        grid-template-columns: minmax(0, 1fr);\n    }\n\n    .dashboard {\n        grid-template-areas:\n            \"resumo\"\n            \"tarefas\"\n            \"agenda\"\n            \"equipe\"\n            \"alertas\";\n    }\n\n    .grade-equipe,\n    .lista-tarefas li {\n        grid-template-columns: minmax(0, 1fr);\n    }\n\n    button {\n        width: 100%;\n    }\n}\n",
      "js": "const botaoDensidade = document.querySelector('#alternarDensidade');\nconst dashboard = document.querySelector('#dashboard');\nconst statusLayout = document.querySelector('#statusLayout');\n\nbotaoDensidade.addEventListener('click', () => {\n    const modoCompactoAtivo = dashboard.classList.toggle('modo-compacto');\n\n    botaoDensidade.setAttribute('aria-pressed', String(modoCompactoAtivo));\n    botaoDensidade.textContent = modoCompactoAtivo\n        ? 'Desativar modo compacto'\n        : 'Ativar modo compacto';\n    statusLayout.textContent = modoCompactoAtivo\n        ? 'Modo compacto ativo: espaçamentos reduzidos.'\n        : 'Layout confortável ativo.';\n});\n"
    },
    "nomesArquivos": {
      "html": "index.html",
      "css": "estilo.css",
  ...
  },
  {
    ...
    "arquivos": {
      ...
      "html": "<!DOCTYPE html>\n<html lang=\"pt-BR\">\n<head>\n    <meta charset=\"UTF-8\">\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    <title>Orçamento rápido - Entrada, processamento e saída</title>\n    <link rel=\"stylesheet\" href=\"estilo.css\">\n    <script src=\"script.js\" defer></script>\n</head>\n<body>\n    <a class=\"pular-conteudo\" href=\"#simulador\">Pular para o simulador</a>\n\n    <header class=\"topo\">\n        <p class=\"etiqueta\">FE07 - Algoritmo, Python e JavaScript</p>\n        <h1>Orçamento rápido de serviço</h1>\n        <p>O mesmo algoritmo será representado em pseudocódigo, executado no navegador com JavaScript e comparado com uma versão para o terminal Python.</p>\n    </header>\n\n    <main id=\"simulador\" class=\"conteudo\">\n        <section class=\"painel painel-formulario\" aria-labelledby=\"titulo-entrada\">\n            <p class=\"etapa\">1 - Entrada</p>\n            <h2 id=\"titulo-entrada\">Dados do orçamento</h2>\n\n            <form id=\"formularioOrcamento\">\n                <div class=\"campo\">\n                    <label for=\"nomeCliente\">Nome do cliente</label>\n                    <input id=\"nomeCliente\" name=\"nomeCliente\" type=\"text\" autocomplete=\"name\" value=\"Cliente Horizonte\" required>\n                </div>\n\n                <div class=\"campo\">\n                    <label for=\"horasPrevistas\">Horas previstas</label>\n                    <input id=\"horasPrevistas\" name=\"horasPrevistas\" type=\"number\" min=\"0.5\" step=\"0.5\" value=\"8\" required>\n                </div>\n\n                <div class=\"campo\">\n                    <label for=\"valorHora\">Valor por hora (R$)</label>\n                    <input id=\"valorHora\" name=\"valorHora\" type=\"number\" min=\"1\" step=\"0.01\" value=\"75\" required>\n                </div>\n\n                <button type=\"submit\">Calcular orçamento</button>\n            </form>\n        </section>\n\n        <section class=\"painel painel-processamento\" aria-labelledby=\"titulo-processamento\">\n            <p class=\"etapa\">2 - Processamento</p>\n            <h2 id=\"titulo-processamento\">Regras do cálculo</h2>\n            <ol>\n                <li><code>subtotal = horas x valor por hora</code></li>\n                <li><code>taxa operacional = subtotal x 10%</code></li>\n                <li><code>total = subtotal + taxa operacional</code></li>\n            </ol>\n            <p class=\"observacao\">Nesta etapa o algoritmo é sequencial: cada instrução depende do resultado produzido pela anterior.</p>\n        </section>\n\n        <section class=\"painel painel-saida\" aria-labelledby=\"titulo-saida\">\n            <p class=\"etapa\">3 - Saída</p>\n            <h2 id=\"titulo-saida\">Resultado calculado</h2>\n            <div id=\"resultadoOrcamento\" class=\"resultado\" role=\"status\" aria-live=\"polite\">\n                Preencha os dados e selecione o botão Calcular orçamento.\n            </div>\n        </section>\n\n        <aside class=\"painel comparacao\" aria-labelledby=\"titulo-comparacao\">\n            <p class=\"etapa\">Comparação</p>\n            <h2 id=\"titulo-comparacao\">Como executar no terminal Python</h2>\n            <ol>\n                <li>Abra a pasta <code>exercicio-07</code> no VS Code.</li>\n                <li>Abra o terminal integrado.</li>\n                <li>Execute <code>python main.py</code>.</li>\n                <li>Digite os mesmos valores usados no navegador.</li>\n                <li>Compare subtotal, taxa e total.</li>\n            </ol>\n        </aside>\n    </main>\n\n    <footer class=\"rodape\">\n        <p>Exercício FE07 - Programação Front-End - 2 DS Subsequente</p>\n    </footer>\n</body>\n</html>\n",
      "css": ":root {\n    --fundo: #07111f;\n    --superficie: #10243a;\n    --superficie-clara: #173550;\n    --texto: #f5f8ff;\n    --texto-suave: #bdcbe0;\n    --destaque: #67e8f9;\n    --sucesso: #86efac;\n    --borda: #31516f;\n    --raio: 18px;\n    --espaco: 20px;\n}\n\n* {\n    box-sizing: border-box;\n}\n\nbody {\n    margin: 0;\n    min-height: 100vh;\n    font-family: Arial, Helvetica, sans-serif;\n    background: var(--fundo);\n    color: var(--texto);\n}\n\n.pular-conteudo {\n    position: absolute;\n    top: -70px;\n    left: 16px;\n    z-index: 10;\n    padding: 12px 16px;\n    border-radius: 10px;\n    background: var(--destaque);\n    color: #04131f;\n    font-weight: 800;\n}\n\n.pular-conteudo:focus {\n    top: 16px;\n}\n\n.topo,\n.conteudo,\n.rodape {\n    width: min(1120px, 92%);\n    margin-inline: auto;\n}\n\n.topo {\n    padding: 46px 0 26px;\n}\n\n.etiqueta,\n.etapa {\n    margin: 0 0 8px;\n    color: var(--destaque);\n    font-weight: 800;\n    letter-spacing: 0.06em;\n    text-transform: uppercase;\n}\n\nh1,\nh2,\np {\n    margin-top: 0;\n}\n\nh1 {\n    max-width: 900px;\n    margin-bottom: 14px;\n    font-size: clamp(2.3rem, 7vw, 5rem);\n    line-height: 1;\n}\n\np,\nli,\nlabel {\n    color: var(--texto-suave);\n    line-height: 1.6;\n}\n\n.conteudo {\n    display: grid;\n    grid-template-columns: repeat(2, minmax(0, 1fr));\n    gap: var(--espaco);\n    padding-bottom: 24px;\n}\n\n.painel {\n    min-width: 0;\n    padding: 24px;\n    border: 1px solid var(--borda);\n    border-radius: var(--raio);\n    background: var(--superficie);\n}\n\n.painel-formulario,\n.painel-saida {\n    grid-row: span 2;\n}\n\nform {\n    display: grid;\n    gap: 16px;\n}\n\n.campo {\n    display: grid;\n    gap: 7px;\n}\n\nlabel {\n    font-weight: 700;\n}\n\ninput,\nbutton {\n    min-height: 48px;\n    border-radius: 11px;\n    font: inherit;\n}\n\ninput {\n    width: 100%;\n    padding: 11px 13px;\n    border: 1px solid var(--borda);\n    background: var(--superficie-clara);\n    color: var(--texto);\n}\n\nbutton {\n    padding: 12px 18px;\n    border: 0;\n    background: var(--destaque);\n    color: #04131f;\n    font-weight: 800;\n    cursor: pointer;\n}\n\nbutton:hover {\n    filter: brightness(1.08);\n}\n\ninput:focus-visible,\nbutton:focus-visible,\na:focus-visible {\n    outline: 3px solid var(--sucesso);\n    outline-offset: 3px;\n}\n\nol {\n    margin-bottom: 0;\n    padding-left: 24px;\n}\n\ncode {\n    color: var(--texto);\n}\n\n.observacao,\n.resultado {\n    margin-top: 18px;\n    padding: 16px;\n    border-radius: 12px;\n    background: var(--superficie-clara);\n}\n\n.resultado {\n    min-height: 190px;\n    border-left: 5px solid var(--sucesso);\n    white-space: pre-line;\n    font-weight: 700;\n    line-height: 1.7;\n}\n\n.rodape {\n    padding: 10px 0 38px;\n}\n\n@media (max-width: 760px) {\n    .conteudo {\n        grid-template-columns: 1fr;\n    }\n\n    .painel-formulario,\n    .painel-saida {\n        grid-row: auto;\n    }\n}\n\n@media (max-width: 460px) {\n    .topo {\n        padding-top: 34px;\n    }\n\n    .painel {\n        padding: 18px;\n    }\n\n    button {\n        width: 100%;\n    }\n}\n",
      "js": "const formulario = document.querySelector('#formularioOrcamento');\nconst campoNome = document.querySelector('#nomeCliente');\nconst campoHoras = document.querySelector('#horasPrevistas');\nconst campoValorHora = document.querySelector('#valorHora');\nconst resultado = document.querySelector('#resultadoOrcamento');\n\nformulario.addEventListener('submit', (evento) => {\n    evento.preventDefault();\n\n    // Entrada\n    const nomeCliente = campoNome.value.trim();\n    const horasPrevistas = Number(campoHoras.value);\n    const valorHora = Number(campoValorHora.value);\n\n    // Processamento\n    const subtotal = horasPrevistas * valorHora;\n    const taxaOperacional = subtotal * 0.10;\n    const total = subtotal + taxaOperacional;\n\n    // Saída\n    resultado.textContent =\n        `Cliente: ${nomeCliente}\n` +\n        `Subtotal: ${subtotal.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}\n` +\n        `Taxa operacional: ${taxaOperacional.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}\n` +\n        `Total: ${total.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}`;\n});\n",
      "python": "print(\"ORÇAMENTO RÁPIDO DE SERVIÇO\")\nprint(\"Entrada -> Processamento -> Saída\")\n\n# Entrada\nnome_cliente = input(\"Nome do cliente: \").strip()\nhoras_previstas = float(input(\"Horas previstas: \"))\nvalor_hora = float(input(\"Valor por hora (R$): \"))\n\n# Processamento\nsubtotal = horas_previstas * valor_hora\ntaxa_operacional = subtotal * 0.10\ntotal = subtotal + taxa_operacional\n\n# Saída\nprint(\"\\nRESULTADO\")\nprint(f\"Cliente: {nome_cliente}\")\nprint(f\"Subtotal: R$ {subtotal:.2f}\")\nprint(f\"Taxa operacional: R$ {taxa_operacional:.2f}\")\nprint(f\"Total: R$ {total:.2f}\")\n",
...
window.DISCIPLINE_CONFIGS = window.DISCIPLINE_CONFIGS || {};
window.DISCIPLINE_CONFIGS.frontend = {"name":"Plataforma 2DS Sub - Programação Front-End - Aluno","shortName":"Programação Front-End","slug":"frontend","storagePrefix":"ds2sub_frontend","version":"0.1.42","releasedAt":"2026-08-12T22:11:00-03:00","versionManifest":"version.json","classroomUrl":"https://classroom.google.com/","githubDefault":"https://github.com/","repositorio":"atividades-frontend-sub","minimumActiveSeconds":300};
window.DISCIPLINES = window.DISCIPLINES || {};
window.DISCIPLINES.frontend = { label: window.DISCIPLINE_CONFIGS.frontend.shortName, config: window.DISCIPLINE_CONFIGS.frontend, exercises: window.EXERCICIOS_FRONTEND };
window.EXERCICIOS = window.EXERCICIOS_FRONTEND;
window.APP_CONFIG = window.DISCIPLINE_CONFIGS.frontend;

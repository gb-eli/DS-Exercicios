window.EXERCICIOS_MOBILE = [
  {
    ...
    "dicasProgressivas": {
      "html": [
        ...
        "Compare o seu trecho com a referência sem colar o código.",
...
window.DISCIPLINE_CONFIGS.mobile = {"name":"Plataforma 2DS Sub - Programação Mobile - Aluno","shortName":"Programação Mobile","slug":"mobile","storagePrefix":"ds2sub_mobile","version":"0.1.42","releasedAt":"2026-08-12T22:11:00-03:00","versionManifest":"version.json","classroomUrl":"https://classroom.google.com/","githubDefault":"https://github.com/","repositorio":"atividades-mobile-sub","minimumActiveSeconds":300};
window.DISCIPLINES = window.DISCIPLINES || {};
window.DISCIPLINES.mobile = { label: window.DISCIPLINE_CONFIGS.mobile.shortName, config: window.DISCIPLINE_CONFIGS.mobile, exercises: window.EXERCICIOS_MOBILE };
if (!window.EXERCICIOS) window.EXERCICIOS = window.EXERCICIOS_MOBILE;
if (!window.APP_CONFIG) window.APP_CONFIG = window.DISCIPLINE_CONFIGS.mobile;
window.ACTIVE_DISCIPLINE = window.ACTIVE_DISCIPLINE || "frontend";

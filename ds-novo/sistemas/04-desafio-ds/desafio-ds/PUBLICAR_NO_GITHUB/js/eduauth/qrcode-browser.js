(function(global){'use strict';var modules={"./QR8bitByte":function(require,module,exports){
...
}};var cache={};function req(id){if(id==='./index')id='./index';if(cache[id])return cache[id].exports;if(!modules[id])throw new Error('QR module '+id+' missing');var m=cache[id]={exports:{}};modules[id](req,m,m.exports);return m.exports;}global.DS_QRCodeModel=req('./index');global.DS_QRErrorCorrectLevel=req('./QRErrorCorrectLevel');})(window);

(function(){
  ...
  function append(ledger,{type='REWARD',amount=0,status='APPROVED',source='atividade',sourceId='',metadata={}}={}){
    ...
    const provisional={id:uuid(),sequence,schemaVersion:SCHEMA,profileId:ledger.profileId,walletId:ledger.walletId,currency:CURRENCY,type,status,amount:value,createdAt:new Date().toISOString(),source,sourceId,appVersion:'27.0.0',deviceSessionId:ledger.sessionId,nonce,previousHash,metadata:Object.freeze({...metadata})};
